...
<template>
    <div class="list-group">
        <RouterLink :to="{name: 'flight', params: {flightNumber: 'NR101'}}" href="#" class="list-group-item list-group-item-action clickable">
        ...
        <RouterLink :to="{name: 'flight', params: {flightNumber: 'NR102'}}" class="list-group-item list-group-item-action clickable">
            <div class="d-flex w-100 mb-1 justify-content-between align-items-start">
                <h5>NR102</h5>
        ...
        <RouterLink :to="{name: 'flight', params: {flightNumber: 'NR103'}}" class="list-group-item list-group-item-action clickable">
            <div class="d-flex w-100 mb-1 justify-content-between align-items-start">
                <h5>NR103</h5>
